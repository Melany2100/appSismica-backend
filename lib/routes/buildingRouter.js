 ...
 *         schema:
 *           type: string
 *         description: Filtra por nombre del edificio o dirección (búsqueda parcial)
 *       - in: query
 *         name: inspector
 *         schema:
 *           type: string
 *         description: Filtra por nombre del inspector asignado (búsqueda parcial)
 *     responses:
 *       200:
 ...
 *     responses:
 *       200:
 *         description: Edificio obtenido exitosamente
 *       401:
 *         description: No autorizado
 *       404:
